            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-primary font-semibold mt-1">{cvPreview.title}</p>
                </div>
                <Button
                  variant="outline"
                  onClick={() => setShowFullCV(!showFullCV)}
                  className="border-white/20 text-white hover:bg-white/10 bg-white/5 backdrop-blur-sm hover:text-primary hover:border-primary/50"
                >
                  {showFullCV ? (
                    <>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="flex items-center text-white/80">
                      ...
                      <a href={cvPreview.contact.portfolio} className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
                        Portfolio
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="border-l-4 border-primary pl-4">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <Badge variant="secondary" className="text-xs bg-primary/10 text-primary border border-primary/20">{cvPreview.currentRole.type}</Badge>
                    </div>
                    <p className="text-primary text-sm">{cvPreview.currentRole.company}</p>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      {cvPreview.keySkills.map((skill, index) => (
                        <Badge key={index} variant="outline" className="border-white/20 text-white hover:border-primary/50 transition-colors">
                          {skill}
                        </Badge>
                      ))}
                    </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      {keyProjects.map((project, index) => (
                        <div key={index} className="bg-white/5 rounded-lg p-4 border border-white/5 hover:border-primary/30 transition-colors">
